...
function PaymentCallback() {
  ...
  const hasVerified = useRef(false); // guards against StrictMode's double-invoke in dev
  ...
  const content = {
    ...
    paid: {
      ...
      body: "Your order has been confirmed. Thank you for shopping with GadgetHub.",
    },
    cancelled: {
      icon: "🚫",
