...
export default function NavBar() {
  ...
  const isActive = (path) => {
    if (path === "/homepage" && (currentPath === "/homepage" || currentPath === "/")) return true;
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-slate-800 bg-[#0B0F19]/90 backdrop-blur-md text-slate-100">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3.5">
        ...
        >
          <div className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-[#080C14] p-1 border border-slate-800 shadow-[0_0_18px_rgba(37,99,235,0.25)] transition-transform duration-300 group-hover:scale-105">
            <svg
              viewBox="0 0 100 100"
              fill="none"
            ...
            >
              <defs>
                ...
                <linearGradient id="g-left" x1="0%" y1="0%" x2="0%" y2="100%">
                  <stop offset="0%" stopColor="#2563EB" />
                  <stop offset="100%" stopColor="#1D4ED8" />
                </linearGradient>
                <linearGradient id="g-tray" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <path
                ...
                fill="url(#g-top)"
              />
              <path d="M 48 42 L 82 42 L 72 52 L 48 52 Z" fill="url(#g-top)" />
              <path
                d="M 28 68 L 50 81 L 72 68 L 72 60 L 50 69 L 28 60 Z"
                fill="url(#g-tray)"
              />
              <circle cx="58" cy="73.5" r="1.2" fill="#93C5FD" />
              <circle cx="62" cy="71.2" r="1.2" fill="#93C5FD" />
            </svg>
          </div>
        ...
        <div className="flex items-center gap-8 text-sm font-semibold">
          <button
            ...
            className={`relative py-1 transition-colors ${
              isActive("/homepage") ? "font-bold text-blue-500" : "text-slate-300 hover:text-white"
            }`}
          >
            Home
            {isActive("/homepage") && (
          ...
          <button
            ...
            className={`relative py-1 transition-colors ${
              isActive("/orders") ? "font-bold text-blue-500" : "text-slate-300 hover:text-white"
            }`}
          >
            Orders
            {isActive("/orders") && (
          ...
          <button
            ...
            className={`relative py-1 transition-colors ${
              isActive("/cart") ? "font-bold text-blue-500" : "text-slate-300 hover:text-white"
            }`}
          >
            Cart
            {isActive("/cart") && (
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              {avatar ? (
                <img
                  src={avatar}
                  alt="Profile"
                  className="h-6 w-6 rounded-full object-cover border border-blue-400/50"
                />
              ) : (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <svg
                ...
                className={`h-4 w-4 transition-transform duration-200 ${
                  isDropdownOpen ? "rotate-180 text-blue-400" : "text-slate-400"
                }`}
              >
                <path
                  fillRule="evenodd"
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 rounded-2xl border border-slate-800 bg-[#111827] py-2 text-sm shadow-2xl backdrop-blur-xl">
                {/* Profile -> Route to Existing AccountPage */}
                <button
                  onClick={() => handleMenuClick("/account")}
                  className="flex w-full items-center gap-3 px-4 py-2.5 text-slate-200 hover:bg-blue-600/10 hover:text-blue-400 transition"
                >
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4 text-blue-400">
                    <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 1113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
                  </svg>
                  Help
                </button>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4 text-blue-400">
                    <path fillRule="evenodd" d="M18 13V5a2 2 0 00-2-2H4a2 2 0 00-2 2v8a2 2 0 002 2h3l3 3 3-3h3a2 2 0 002-2zM5 7a1 1 0 011-1h8a1 1 0 110 2H6a1 1 0 01-1-1zm0 4a1 1 0 011-1h5a1 1 0 110 2H6a1 1 0 01-1-1z" clipRule="evenodd" />
                  </svg>
                  Feedback
                </button>
              </div>
