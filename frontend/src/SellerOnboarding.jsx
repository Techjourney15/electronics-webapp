  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#eef3fb] text-slate-900">
      ...
      <div className="relative flex min-h-screen items-center justify-center px-4 py-10">
        <div className="mx-auto w-full max-w-[460px] rounded-[26px] border border-[#d3e0f5]/35 bg-[rgba(238,243,251,0.78)] p-3 shadow-[0_12px_48px_-12px_rgba(141,109,72,0.22)] backdrop-blur-xl">
